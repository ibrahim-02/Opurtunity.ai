...
BASE_DIR = Path(__file__).resolve().parent.parent   # scrapers.indeed/
...
MAX_PAGES_PER_QUERY = int(os.getenv("INDEED_MAX_PAGES", "3"))
...
# ── Optional JSON override: scrapers.indeed/config/search_terms.json ───────────
# Expected format: { "skills": [...], "queries": [...] }
...
# Job-title searches only — skill terms (SQL, ETL, etc.) return too many non-technical jobs
ALL_SEARCH_TERMS = SEARCH_QUERIES
