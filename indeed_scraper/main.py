...
from indeed_scraper.database.repository import JobRepository
from indeed_scraper.scraper.indeed_scraper import IndeedScraper
...
if __name__ == "__main__":
    ...
    if args.query:
        ...
        queries_to_run = _cfg.SEARCH_QUERIES
